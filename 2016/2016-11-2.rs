...
use regex::Regex;
use crate::s_2016_11_2::Direction::{Down, Up};
use crate::s_2016_11_2::Element::{Cobalt, Curium, Dilithium, Elerium, Plutonium, Promethium, Ruthenium};
use crate::s_2016_11_2::Floor::{F1, F2, F3, F4};
use crate::s_2016_11_2::Status::{Completed, Invalid, Valid};
use crate::s_2016_11_2::Type::{Generator, Microchip};
...
static ELEMENTS: [Element; 7] = [Cobalt, Curium, Dilithium, Elerium, Plutonium, Promethium, Ruthenium];
...
pub fn solve() {
    let mut area = create_area_from_input();
    for item_type in vec![Microchip, Generator] {
        area.first_floor.insert(Item { element: Dilithium, item_type });
        area.first_floor.insert(Item { element: Elerium, item_type });
    }
